    ...
    <div class="container" style="margin-top: 70px;">
        ...
        <div class="row clearfix">
            <div class="col-md-12 col-xs-12">
                <img src="snap2/s2.1.png" class="col-md-12 col-xs-12">
                <img src="snap2/s2.2.png" class="col-md-6 col-xs-12">
                <img src="snap2/s2.3.png" class="col-md-6 col-xs-12">
                <img src="snap2/s2.6.png" class="col-md-6 col-xs-12">
                <img src="snap2/s2.7.png" class="col-md-6 col-xs-12">

                <img src="snap2/s2.5.png" class="col-md-6 col-xs-12">
                <img src="snap2/s2.4.png" class="col-md-3 col-xs-12">
            </div>
        </div>
    </div>
    <?php
